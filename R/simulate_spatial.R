...
#' @title Simulates new weather series over a grid or arbitrary locations.
#' @description This function generates synthetic weather series on locations that
#' were not necesarilly used to fit the models. Every location is spatially correlated so
#' series could be generated either over points or a grid.
...
#' simulated. If not set, the locations used to fit the model will be used. The object could
#' also be a grid or random points but the sf object must be made a point object.
