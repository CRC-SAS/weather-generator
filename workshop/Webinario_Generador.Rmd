...
if (!fs::file_exists('input_data/local/climate.csv')) {
  write.csv(readr::read_csv(system.file('/autorun/local', "climate.csv",  package = "gamwgen"), col_types = "Diddd"), here::here('input_data/local/climate.csv'), row.names = FALSE)
}
```
...
ggplot2::ggplot(umbrales_temperatura, ggplot2::aes(x = month, y = valor, color = rango)) +
  ...
  ggplot2::labs(x = 'Meses', 
                title = 'Rango de la amplitud térmica en Villa Reynolds Aero (87448)',
                col = 'Amplitud') +
  ggplot2::theme_bw() +
  ggplot2::theme(
